...
// Tambahkan event listener untuk menutup navbar saat mengklik di luar menu navigasi
document.addEventListener('click', function(e) {
  const mobileNav = select('.mobile-nav');
  if (!mobileNav.contains(e.target) && !e.target.classList.contains('mobile-nav-toggle')) {
